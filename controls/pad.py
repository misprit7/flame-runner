...
# https://github.com/vladfi1/phillip/blob/master/phillip/pad.py
...
class Pad:
    ...
    This should be using a fifo, but due to a bug in dolphin I'm instead
    just using a regular file
    """
